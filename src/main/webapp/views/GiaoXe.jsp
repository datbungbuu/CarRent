...
<div class="row" style="height: 786px">
	...
	<%-- <%@include file = "/common/nav.jsp" %> --%>
				...
				<form:form action="/car/giaoxe" method="post" modelAttribute="item">
				<div class="row">
				<div class="col-sm-2">
				<input class="form-control form-control-sm" type="text" placeholder="Số Hợp Đồng" name="mahd">
				</div>
				</div>
									...
									<div class="row mt-2 mb-3">
										...
										<div class="row">
										 <div class="mb3">
											 	...
											 	<form:input type="text" class="form-control" path="ngayGiaoXe" value = "2023/09/15"/>
											 </div>	
											<div class="col-sm-6"> 
												<div class="mb-3">
