...
<div class="row" style="height: 786px">
	...
	<%@include file = "/common/nav.jsp" %>
		<div class="row justify-content-center m-0" >
			<h1 class="text-center mt-3 mb-3" style="color: #289d8c">Danh Sách Hợp Đồng Chưa Xác Nhận</h1>
					...
					<tbody>
					 <c:forEach items="${listContract}" var="item">
					    <tr>
					      ...
					      <td> <a href="/contract/view-contract?id=${item.maHopDong }" class="text-decoration-none"><i class="fa-solid fa-pencil"></i></a> </td>
					    </tr>
					</c:forEach>	 	  
					</tbody>
				</table>
